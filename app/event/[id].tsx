...
const styles = StyleSheet.create({
  ...
  heroDark: { backgroundColor: '#232832', borderColor: '#1e293b' },
  ...
  sectionDark: { backgroundColor: '#232832', borderColor: '#1e293b' },
  ...
  taskRowDark: { borderColor: '#334155', backgroundColor: '#232832' },
  task: { fontSize: 13 },
